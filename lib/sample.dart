...
class _GoLivePageState extends State<GoLivePage> {
  ...
  void uploadVideoFile(XFile? video) {
  ...
  Future<void> uploadImageFile(List<XFile> imageList) async {
    ...
    List<firebase_storage.Reference> uploadedRefs = [];
    ...
    for (var imageFile in imageList) {
      ...
      try {
        ...
        print('Errors uploading image: $e');
      }
      catch (error) {
        print('Error uploading image: $error');
      }
    }
    print('Total images selected: ${imageList.length}');
    print('Total images uploaded: ${uploadedRefs.length}');
