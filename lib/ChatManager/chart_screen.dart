...
import '../Utils/full_photo.dart';
import '../Utils/progress_bar.dart';
import 'chat_provider.dart';
import 'chat_user_error.dart';
  ...
  void getLocal() {
    ...
    if(firebaseAuth.currentUser!.uid.isNotEmpty == true){
      ...
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => ChatUserError()),
    ...
    chatProvider.updateDataFirestore(
      FirestoreConstants.friendsCollection,
      currentUserID,
...
class ChatScreenArgs {
  ...
  ChatScreenArgs({required this.peerId, required this.peerAvatar,
    required this.peerLocation, required this.peerName});
}
